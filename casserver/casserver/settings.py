"""
Django settings for casserver project.
...
import os
import sys
sys.path.append('/home/godlike/projects/cas-testbed/django-mama-cas')
...
SECRET_KEY = 'yg7o&stemq!0!gg11(to(b2)_aller&((ec5j(kh%&!(&)t!s0'
